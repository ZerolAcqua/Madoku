...
class TestScene(Scene):
    ...
    def construct(self):
        ...
        # Sudoku1.save_state()
        self.play(FadeOutWithParticles1(Sudoku1.cands[1],run_time=6),FadeOutWithParticles1(Sudoku1.cands[5],parti_color=PINK)
                  ,FadeOutWithParticles1(Sudoku1.cands[10],parti_color=YELLOW_B,squares=10))
